...
const Header = (props: Props) => {
    return (
        <div
            ...
            data-w-id="1fbcdb53-0d91-fef6-471a-1a46d60013bd"
            role="banner"
            data-duration="400"
            data-doc-height="1"
        >
            <div className="container-nav w-container">
                <div className="wrapper-nav-left">
                    <Link href="#top-of-the-page">
                        {/* <h3 className="font-kassi_classic text-5xl is-blue">TECHFORGE</h3> */}
                        <div className="flex flex-row items-center">
                            <h3 className="font-kassi_classic text-5xl text-[#ea4234]">DIGI</h3>
                            <h3 className="font-kassi_classic text-5xl is-blue">PLUS</h3>
                            <h3 className="font-kassi_classic text-5xl bg-[#39a853] text-white px-1 ml-1">IT</h3>
                        </div>
                    </Link>
                </div>
